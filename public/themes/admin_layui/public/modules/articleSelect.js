layui.define(['table', 'jquery', 'form'], function (exports) {
    ...
    var MOD_NAME = 'articleSelect',
        $ = layui.jquery,
        table = layui.table,
        form = layui.form;
    var articleSelect = function () {
        this.v = '1.0.1';
    };
    ...
    * 初始化表格选择器
    */
    articleSelect.prototype.render = function (opt) {
        var elem = $(opt.elem);
        //默认设置
    ...
    * 隐藏选择器
    */
    articleSelect.prototype.hide = function (opt) {
        $('.tableSelect').remove();
    };

    //自动完成渲染
    var articleSelect = new articleSelect();
    ...
    exports(MOD_NAME, articleSelect);
});